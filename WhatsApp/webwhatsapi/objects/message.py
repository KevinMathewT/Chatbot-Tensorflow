...
from WhatsApp.webwhatsapi.helper import safe_str
from WhatsApp.webwhatsapi.objects.contact import Contact
from WhatsApp.webwhatsapi.objects.whatsapp_object import WhatsappObject
